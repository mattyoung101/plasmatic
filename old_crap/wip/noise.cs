...
using System;
public static class PerlinNoiseFixedPoint
{
    public static float Noise3D(float x, float y, float z)
    {
        return Noise3D((int)(x * 65536), (int)(y * 65536), (int)(z * 65536)) / 65536f; //65536 = 2 ^ 16
    }
    ...
    static int Fade(int t) // returns 0~4095
    {
        int t0 = f[t >> 8];
        int t1 = f[Math.Min(255, (t >> 8) + 1)];
